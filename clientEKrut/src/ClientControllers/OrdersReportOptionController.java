...
/**
 * The Class OrdersReportOptionController is controller for the screen OrdersReportOption.fxml.
 * This class is setup the screen at first and than gives tthe CEO or to the Regional Manager options to choose specific
 * report to look at
 */
public class OrdersReportOptionController {
    ...
    void getOrderReport(ActionEvent event) {
    	...
    	if(rMessage.equals("get Report Success"))
    	{
    		...
    		scene.changeScreen(new Stage(),"/clientGUI/ViewSpecificOrdersReport.fxml");
    	}
    }
