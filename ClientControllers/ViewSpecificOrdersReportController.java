...
import javafx.scene.text.Text;
	 ...
	 */
	public class ViewSpecificOrdersReportController {
		...
		@FXML
		private Text topsellerTXT;  

		@FXML
		private Text leastsellerTXT;  
		@FXML
		private Text totalordersTXT; 
		@FXML
		...
		@FXML
		private static ArrayList<Report> repoList;
	    ...
	    public void initialize() {
	    	...
	    	topsellerTXT.setText(repo.gettopSeller());
	    	leastsellerTXT.setText(repo.getleastSeller());
	    	totalorders=(repo.gettotalOrders()+"");
	    	totalordersTXT.setText(totalorders);
